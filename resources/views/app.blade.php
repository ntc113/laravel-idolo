...
<head>
    ...
    <title>{{ config('cc.app_name') }} - {{ config('cc.app_slogan') }}</title>
    <!-- Favicons-->
    ...
    <meta content="@yield('title', config('cc.app_name'))" property="og:title">
    <meta content="@yield('description', config('cc.app_slogan'))" property="og:description">
